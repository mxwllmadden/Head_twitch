...
video_path = r'Videos'  # CHANGE!
files = [f for f in os.listdir(video_path) if f.endswith('.mp4')]

# Path to MODEL
model = r'Mice Master N\models\240716_170449.single_instance.n=1996\training_config.json'  # CHANGE!

# Path to TRAJECTORY STORAGE
output_path = r'transform_result'  # CHANGE!

# Path to SLEAP ENVIRONMENT on your PC
sleap_env = input('Path to sleap env folder: ')
command = rf'{sleap_env}\Scripts\sleap-track'  # CHANGE!

# Path and name of the created BATCH FILE with all the tracking commands
batch_file_path = r'track_list_1.bat'  # CHANGE!
...
traj_path = r'transform_result'  # CHANGE!
files = [f for f in os.listdir(traj_path) if f.endswith('.predictions.slp')]

# Path to H5 FILE STORAGE
h5_output_path = r'h5_result'  # CHANGE!

# Path to SLEAP ENVIRONMENT on your PC
convert_command = rf'{sleap_env}\Scripts\sleap-convert --format analysis -o '  # CHANGE!

# Path and name of the created BATCH FILE with all the conversion commands
convert_batch_file_path = r'convert_list_1.bat'  # CHANGE!
